...
: running_(true)
  ...
  , stop_srv_(nh.advertiseService("stop", &MyRobotHWInterface::stop_callback, this)) 
  {
    ...
    front_left_wheel_vel_pub_ = nh.advertise<ros_phoenix::MotorControl>("/front_left/set", 1);
    back_left_wheel_vel_pub_ = nh.advertise<ros_phoenix::MotorControl>("/back_left/set", 1);
    front_right_wheel_vel_pub_ = nh.advertise<ros_phoenix::MotorControl>("/front_right/set", 1);
    back_right_wheel_vel_pub_ = nh.advertise<ros_phoenix::MotorControl>("/back_right/set", 1);
