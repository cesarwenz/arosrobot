...
#include "arosrobot_base/TalonNode.h"
#include "arosrobot_base/MotorControl.h"
#include "arosrobot_base/Reset.h"
...
public:
  ...
  void write() {
    ...
    arosrobot_base::MotorControlPtr left(new arosrobot_base::MotorControl);
    left->mode = arosrobot_base::MotorControl::VELOCITY;
    left->value = left_wheel_vel_msg.data;
    arosrobot_base::MotorControlPtr right(new arosrobot_base::MotorControl);
    right->mode = arosrobot_base::MotorControl::VELOCITY;
...
: running_(true)
  ...
  , stop_srv_(nh.advertiseService("stop", &MyRobotHWInterface::stop_callback, this)) 
  {
    ...
    front_left_wheel_vel_pub_ = nh.advertise<arosrobot_base::MotorControl>("/front_left/set", 1);
    back_left_wheel_vel_pub_ = nh.advertise<arosrobot_base::MotorControl>("/back_left/set", 1);
    front_right_wheel_vel_pub_ = nh.advertise<arosrobot_base::MotorControl>("/front_right/set", 1);
    back_right_wheel_vel_pub_ = nh.advertise<arosrobot_base::MotorControl>("/back_right/set", 1);
