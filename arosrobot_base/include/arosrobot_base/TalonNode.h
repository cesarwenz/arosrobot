#ifndef AROSROBOT_BASE_TALON_H
#define AROSROBOT_BASE_TALON_H
...
#include "arosrobot_base/TalonConfig.h"
#include "arosrobot_base/MotorControl.h"
#include "arosrobot_base/MotorAngle.h"
#include "arosrobot_base/MotorStatus.h"
...
public:
    ...
    bool resetOdom(arosrobot_base::Reset::Request &req, 
		    arosrobot_base::Reset::Response &res);
};

} // namespace arosrobot_base

#endif // AROSROBOT_BASE_TALON_H
